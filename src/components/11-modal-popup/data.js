export const data = {
  ...
  main: `Space, the final frontier. Its not just a vast expanse of nothingness; it's filled with unimaginable phenomena—black holes, supernovae, and distant galaxies waiting to be explored.
